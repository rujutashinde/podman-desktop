...
If a PR can't reasonably be split e.g. you are modifying an existing API (or method) and you also have to modify all the consumers, use separate, well-scoped commits and rebase-and-merge instead of squash-and-merge. This keeps `main`'s history easier to read and bisect later.
